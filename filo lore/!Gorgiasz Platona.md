# **Ćwiczenia**: 
- Gorgiasz (jak to dialog [[Platon|Platona]]) nie jest **do końca** dialogiem, tj. monologiem, ale jest bliżej prawdziwego dialogu niż późniejszy Platon
...
- Ciekawy tejk, że platońska sprawiedliwość i podział na *role społeczne* odpowiada częścią duszy jest odpowiedzią na sofistów, którzy zajmują się *wszystkim*
- Grecki view: świat jest zmienny ~> wątpliwy
- Tejk, że we *współczesnych liberalnych społeczeństwach*, sferę tabu, moralności, z seksu przejęła dieta
- Kallikles i Sokrates się rozmijają
- Uzasadnienie to upowszechnienie przekonania
# **Tekst**:
## Sokrates
