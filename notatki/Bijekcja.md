## [[Funkcja|Funkcję]] $f:A\to B$ nazwiemy **bijekcją**, **funkcją wzajemnie jednoznaczną** $f:A\overset{\text{1-1}}{\underset{\text{na}}\to}B$, gdy jest jednocześnie [[Iniekcja|iniekcją]] i [[Suriekcja|suriekcją]]. 
## **Własności**:
