## [[Algebry podobne]] $\mathbb{A}=(A,a_1,...,a_m,f_1,...,f_n)$ $\mathbb{B}=(B,b_1,...,b_m,g_1,...,g_n)$ nazywamy **algebrami izomorficznymi** jeśli istnieje [[Bijekcja|bijekcja]] $F:A\overset{\text{1-1}}{\underset{\text{na}}\to}B$ spełniająca:
